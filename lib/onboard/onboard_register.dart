...
import 'package:umsoapp/api/http_api.dart';
import 'package:umsoapp/api/model/register_post.dart';
import 'package:umsoapp/api/model/token_post.dart';
import 'package:umsoapp/components/onboard_button.dart';
import 'package:umsoapp/components/onboard_input.dart';
import 'package:umsoapp/onboard/onboard_login.dart';
...
class OnboardRegisterScreen extends StatelessWidget {
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: OnboardButton(
                onPressed: () => {
                    _registerUser(context, _userName, _email, _password)
                },
                child: const Text(
                  'Registrieren',
                  style: TextStyle(
  ...
  void _registerUser(BuildContext context, String userName, String email, String password) async {
    var storedBaseUrl = await HttpService.getCurrentServerUrl();
    if (storedBaseUrl != null) {
      httpService.baseApiUrl = storedBaseUrl;
    }
    RegisterModel registeredUser = await httpService.registerUser(userName, email, password);
