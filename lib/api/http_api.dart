...
import 'package:umsoapp/api/model/post_get.dart';
import 'package:umsoapp/api/model/register_post.dart';
import 'model/token_post.dart';

class HttpService {
  String baseApiUrl = "http://teilen.umsonstapp.de";
  String accessToken = "";
  ...
  Future<RegisterModel> registerUser(String userName, String email, String password) async {
    Response res = await post(Uri.parse('$baseApiUrl/register/'),
